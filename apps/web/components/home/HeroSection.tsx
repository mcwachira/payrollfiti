        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button variant="neutral" size="lg" className="px-8 py-4" asChild>
                <Link href="/contact">
          ...
          <div className="relative">
            <div className="bg-card rounded-2xl shadow-brutal-lg p-8 border-2 border-border">
              ...
              {/* Floating Cards */}
              <div className="absolute -top-4 -left-4 bg-secondary-background text-primary-foreground p-4 rounded-lg border-2 border-border shadow-brutal">
