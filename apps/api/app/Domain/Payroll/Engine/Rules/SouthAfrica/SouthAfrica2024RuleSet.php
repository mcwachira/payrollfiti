...
namespace App\Domain\Payroll\Engine\Rules\SouthAfrica;
...
final class SouthAfrica2024RuleSet implements CountryRuleSet
{
    ...
    {
        return [
            new StatutoryDeductionLine('UIF', 'Unemployment Insurance Fund', Money::round2(Money::mul($grossPay, '0.01')), '0'),
        ];
    }

    public function calculateTax(string $grossPay, array $statutoryDeductions): TaxResult
    {
        $tax = Money::round2(Money::mul($grossPay, '0.08'));
